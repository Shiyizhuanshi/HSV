// Dafny program tasks_2024.dfy compiled into C#
...
// Command-line arguments: run --no-verify /Users/james_jiao/Downloads/HSV/HSV/dafny/2024/tasks_2024.dfy
// tasks_2024.dfy

function symbols_clause(c: clause): set<symbol>
  ensures forall xb: (symbol, bool) {:trigger xb.0} {:trigger xb in c} :: xb in c ==> xb.0 in symbols_clause(c)
  ensures forall x: int {:trigger x in symbols_clause(c)} :: x in symbols_clause(c) ==> exists b: bool {:trigger (x, b)} :: (x, b) in c
  decreases c
{
  if c == [] then
    {}
  else
    assert forall xb: (symbol, bool) {:trigger xb in c[1..]} {:trigger xb in c} :: xb in c ==> xb in {c[0]} || xb in c[1..]; {c[0].0} + symbols_clause(c[1..])
}
...
predicate evaluate_clause(c: clause, r: valuation)
  decreases c, r
{
  exists xb: (symbol, bool) {:trigger xb in r.Items} {:trigger xb in c} :: 
    xb in c &&
    xb in r.Items
}
...
predicate same_elements(xs: seq<symbol>, ys: seq<symbol>)
  decreases xs, ys
{
  (forall i: int {:trigger xs[i]} :: 
    0 <= i < |xs| ==>
      xs[i] in ys) &&
  forall j: int {:trigger ys[j]} :: 
    0 <= j < |ys| ==>
      ys[j] in xs
}
...
lemma dupe_free_concat(xs: seq<symbol>, ys: seq<symbol>)
  ...
  decreases xs, ys
{
  assert forall i: int, j: int {:trigger (xs + ys)[j], (xs + ys)[i]} :: 0 <= i < j < |xs + ys| ==> (xs + ys)[i] != (xs + ys)[j];
}
  ...
  decreases c, xs
{
  if c == [] then
    ...
    var c': clause := remove_symbols_clause(c[1..], xs); if c[0].0 in xs then c' else [c[0]] + c'
}
...
function symbol_seq_clause(c: clause): seq<symbol>
  ...
  ensures forall x: int {:trigger x in symbols_clause(c)} {:trigger x in symbol_seq_clause(c)} :: x in symbol_seq_clause(c) <==> x in symbols_clause(c)
  decreases |symbols_clause(c)|
{
  if c == [] then
    []
  else
    var x: symbol := c[0].0; var c': clause := remove_symbols_clause(c[1..], {x}); [x] + symbol_seq_clause(c')
}
...
method Main(_noArgsParameter: seq<seq<char>>)
{
  var sat: bool;
  var r: valuation;
  var q1 := [[(1, true), (2, true)], [(2, false), (3, true)]];
  var q2 := [[(1, true), (2, true)], [(1, false)], [(2, false)]];
  var q3 := [[(1, true), (2, false)]];
  var q4 := [[(2, false), (1, true)]];
...
namespace _module {
  ...
  public partial class __default {
    public static Dafny.ISet<BigInteger> symbols__clause(Dafny.ISequence<_System._ITuple2<BigInteger, bool>> c) {
      Dafny.ISet<BigInteger> _0___accumulator = Dafny.Set<BigInteger>.FromElements();
    TAIL_CALL_START: ;
      if ((c).Equals(Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements())) {
        return Dafny.Set<BigInteger>.Union(Dafny.Set<BigInteger>.FromElements(), _0___accumulator);
      } else {
        _0___accumulator = Dafny.Set<BigInteger>.Union(_0___accumulator, Dafny.Set<BigInteger>.FromElements(((c).Select(BigInteger.Zero)).dtor__0));
        Dafny.ISequence<_System._ITuple2<BigInteger, bool>> _in0 = (c).Drop(BigInteger.One);
        c = _in0;
        goto TAIL_CALL_START;
      }
    }
    public static Dafny.ISet<BigInteger> symbols(Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> q) {
      Dafny.ISet<BigInteger> _0___accumulator = Dafny.Set<BigInteger>.FromElements();
    TAIL_CALL_START: ;
      if ((q).Equals(Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.FromElements())) {
        return Dafny.Set<BigInteger>.Union(Dafny.Set<BigInteger>.FromElements(), _0___accumulator);
      } else {
        _0___accumulator = Dafny.Set<BigInteger>.Union(__default.symbols__clause((q).Select(BigInteger.Zero)), _0___accumulator);
        Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> _in0 = (q).Drop(BigInteger.One);
        q = _in0;
        goto TAIL_CALL_START;
      }
    }
    public static bool evaluate__clause(Dafny.ISequence<_System._ITuple2<BigInteger, bool>> c, Dafny.IMap<BigInteger,bool> r)
    {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>, Dafny.IMap<BigInteger,bool>, bool>>((_0_c, _1_r) => Dafny.Helpers.Quantifier<_System._ITuple2<BigInteger, bool>>((_0_c).UniqueElements, false, (((_exists_var_0) => {
        _System._ITuple2<BigInteger, bool> _2_xb = (_System._ITuple2<BigInteger, bool>)_exists_var_0;
        return ((_0_c).Contains(_2_xb)) && ((Dafny.Map<BigInteger, bool>.Items((_1_r))).Contains(_2_xb));
      }))))(c, r);
    }
    public static bool evaluate(Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> q, Dafny.IMap<BigInteger,bool> r)
    {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>, Dafny.IMap<BigInteger,bool>, bool>>((_0_q, _1_r) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_q).Count)), true, (((_forall_var_0) => {
        BigInteger _2_i = (BigInteger)_forall_var_0;
        return !(((_2_i).Sign != -1) && ((_2_i) < (new BigInteger((_0_q).Count)))) || (__default.evaluate__clause((_0_q).Select(_2_i), _1_r));
      }))))(q, r);
    }
    public static bool dupe__free(Dafny.ISequence<BigInteger> xs) {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<BigInteger>, bool>>((_0_xs) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_xs).Count)), true, (((_forall_var_0) => {
        BigInteger _1_i = (BigInteger)_forall_var_0;
        return Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange((_1_i) + (BigInteger.One), new BigInteger((_0_xs).Count)), true, (((_forall_var_1) => {
          BigInteger _2_j = (BigInteger)_forall_var_1;
          return !((((_1_i).Sign != -1) && ((_1_i) < (_2_j))) && ((_2_j) < (new BigInteger((_0_xs).Count)))) || (((_0_xs).Select(_1_i)) != ((_0_xs).Select(_2_j)));
        })));
      }))))(xs);
    }
    public static bool same__elements(Dafny.ISequence<BigInteger> xs, Dafny.ISequence<BigInteger> ys)
    {
      return (Dafny.Helpers.Id<Func<Dafny.ISequence<BigInteger>, Dafny.ISequence<BigInteger>, bool>>((_0_xs, _1_ys) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_xs).Count)), true, (((_forall_var_0) => {
        BigInteger _2_i = (BigInteger)_forall_var_0;
        return !(((_2_i).Sign != -1) && ((_2_i) < (new BigInteger((_0_xs).Count)))) || ((_1_ys).Contains((_0_xs).Select(_2_i)));
      }))))(xs, ys)) && (Dafny.Helpers.Id<Func<Dafny.ISequence<BigInteger>, Dafny.ISequence<BigInteger>, bool>>((_3_ys, _4_xs) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_3_ys).Count)), true, (((_forall_var_1) => {
        BigInteger _5_j = (BigInteger)_forall_var_1;
        return !(((_5_j).Sign != -1) && ((_5_j) < (new BigInteger((_3_ys).Count)))) || ((_4_xs).Contains((_3_ys).Select(_5_j)));
      }))))(ys, xs));
    }
    public static bool no__same__elements(Dafny.ISequence<BigInteger> xs, Dafny.ISequence<BigInteger> ys)
    {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<BigInteger>, Dafny.ISequence<BigInteger>, bool>>((_0_xs, _1_ys) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_xs).Count)), true, (((_forall_var_0) => {
        BigInteger _2_i = (BigInteger)_forall_var_0;
        return !(((_2_i).Sign != -1) && ((_2_i) < (new BigInteger((_0_xs).Count)))) || (!(_1_ys).Contains((_0_xs).Select(_2_i)));
    ...
    public static Dafny.ISequence<BigInteger> rev(Dafny.ISequence<BigInteger> xs)
    {
      Dafny.ISequence<BigInteger> ys = Dafny.Sequence<BigInteger>.Empty;
      if ((xs).Equals(Dafny.Sequence<BigInteger>.FromElements())) {
        ys = Dafny.Sequence<BigInteger>.FromElements();
      } else {
        Dafny.ISequence<BigInteger> _out0;
        _out0 = __default.rev((xs).Drop(BigInteger.One));
        ys = _out0;
        ys = Dafny.Sequence<BigInteger>.Concat(ys, Dafny.Sequence<BigInteger>.FromElements((xs).Select(BigInteger.Zero)));
      }
      return ys;
    }
    public static Dafny.ISequence<BigInteger> rev2(Dafny.ISequence<BigInteger> xs)
    {
      Dafny.ISequence<BigInteger> ys = Dafny.Sequence<BigInteger>.Empty;
      ys = Dafny.Sequence<BigInteger>.FromElements();
      BigInteger _0_i;
      _0_i = (new BigInteger((xs).Count)) - (BigInteger.One);
      while ((_0_i).Sign != -1) {
        ys = Dafny.Sequence<BigInteger>.Concat(Dafny.Sequence<BigInteger>.FromElements((xs).Select(_0_i)), ys);
        _0_i = (_0_i) - (BigInteger.One);
      }
      return ys;
    }
    public static Dafny.ISequence<_System._ITuple2<BigInteger, bool>> remove__symbols__clause(Dafny.ISequence<_System._ITuple2<BigInteger, bool>> c, Dafny.ISet<BigInteger> xs)
    {
      if ((c).Equals(Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements())) {
        return Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements();
      } else {
        Dafny.ISequence<_System._ITuple2<BigInteger, bool>> _0_c_k = __default.remove__symbols__clause((c).Drop(BigInteger.One), xs);
        if ((xs).Contains(((c).Select(BigInteger.Zero)).dtor__0)) {
          return _0_c_k;
        } else {
          return Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.Concat(Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements((c).Select(BigInteger.Zero)), _0_c_k);
        }
      }
    }
    public static Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> remove__symbols(Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> q, Dafny.ISet<BigInteger> xs)
    {
      Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> _0___accumulator = Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.FromElements();
    TAIL_CALL_START: ;
      if ((q).Equals(Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.FromElements())) {
        return Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.Concat(_0___accumulator, Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.FromElements());
      } else {
        _0___accumulator = Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.Concat(_0___accumulator, Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.FromElements(__default.remove__symbols__clause((q).Select(BigInteger.Zero), xs)));
        Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> _in0 = (q).Drop(BigInteger.One);
        Dafny.ISet<BigInteger> _in1 = xs;
        q = _in0;
        xs = _in1;
        goto TAIL_CALL_START;
      }
    }
    public static Dafny.ISequence<BigInteger> symbol__seq__clause(Dafny.ISequence<_System._ITuple2<BigInteger, bool>> c) {
    ...
    TAIL_CALL_START: ;
      if ((c).Equals(Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements())) {
        ...
        BigInteger _1_x = ((c).Select(BigInteger.Zero)).dtor__0;
        Dafny.ISequence<_System._ITuple2<BigInteger, bool>> _2_c_k = __default.remove__symbols__clause((c).Drop(BigInteger.One), Dafny.Set<BigInteger>.FromElements(_1_x));
        _0___accumulator = Dafny.Sequence<BigInteger>.Concat(_0___accumulator, Dafny.Sequence<BigInteger>.FromElements(_1_x));
        Dafny.ISequence<_System._ITuple2<BigInteger, bool>> _in0 = _2_c_k;
        c = _in0;
        goto TAIL_CALL_START;
      }
    }
    ...
    {
      bool _0_sat = false;
      Dafny.IMap<BigInteger,bool> _1_r = Dafny.Map<BigInteger, bool>.Empty;
      Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> _2_q1;
      _2_q1 = Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.FromElements(Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements(_System.Tuple2<BigInteger, bool>.create(BigInteger.One, true), _System.Tuple2<BigInteger, bool>.create(new BigInteger(2), true)), Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements(_System.Tuple2<BigInteger, bool>.create(new BigInteger(2), false), _System.Tuple2<BigInteger, bool>.create(new BigInteger(3), true)));
      Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> _3_q2;
      _3_q2 = Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.FromElements(Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements(_System.Tuple2<BigInteger, bool>.create(BigInteger.One, true), _System.Tuple2<BigInteger, bool>.create(new BigInteger(2), true)), Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements(_System.Tuple2<BigInteger, bool>.create(BigInteger.One, false)), Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements(_System.Tuple2<BigInteger, bool>.create(new BigInteger(2), false)));
      Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> _4_q3;
      _4_q3 = Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.FromElements(Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements(_System.Tuple2<BigInteger, bool>.create(BigInteger.One, true), _System.Tuple2<BigInteger, bool>.create(new BigInteger(2), false)));
      Dafny.ISequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>> _5_q4;
      _5_q4 = Dafny.Sequence<Dafny.ISequence<_System._ITuple2<BigInteger, bool>>>.FromElements(Dafny.Sequence<_System._ITuple2<BigInteger, bool>>.FromElements(_System.Tuple2<BigInteger, bool>.create(new BigInteger(2), false), _System.Tuple2<BigInteger, bool>.create(BigInteger.One, true)));
      Dafny.ISet<BigInteger> _6_symbols__clause;
      _6_symbols__clause = __default.symbols__clause((_2_q1).Select(BigInteger.Zero));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("symbols_clause = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_6_symbols__clause));
